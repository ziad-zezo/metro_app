...
class _HomePageState extends State<HomePage> {
  ...
  void printRoute() {
    final line1 = line1Stations;
    final line2 = line2Stations;
    final line3 = line3Stations;
    Map<String, List<StationModel>> lines = {
      'Line1': line1,
      'Line2': line2,
      'Line3': line3,
    };
    if (fromStation?.line == toStation?.line) {
      print('the route is from ${fromStation!.name} to ${toStation!.name}');
      final fromIndex = lines[fromStation!.line]!.indexOf(fromStation!);
      final toIndex = lines[toStation!.line]!.indexOf(toStation!);
      if (fromIndex < toIndex) {
        final route = lines[fromStation!.line]!.sublist(fromIndex, toIndex + 1);
        print(route.map((e) => e.name).toList());
      } else {
        final route = lines[fromStation!.line]!
